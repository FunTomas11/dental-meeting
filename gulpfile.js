let preprocessor = 'styl', // Preprocessor (sass, less, styl); 'sass' also work with the Scss syntax in blocks/ folder.
...
export default series(scripts, styles, images, parallel(browsersync, start))
